...
TOKEN = '6329805107:AAGsCtJt8XY3Hbg_517LmmiJbwl0PXGpcA8'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002198480671
CHANNEL_ID = -1002198480671
error_channel_id = -1002198480671
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACCESS:-@KRISHNAVVIPMODS*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "":
        ...
        bot.send_message(message.chat.id, "*FOR RESELLERSHIP  DM:-@KRISHNAVVIPMODS*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("Starting Krishna vip server...")
    while True:
        try:
